...
// Frees the memory allocated for the linear system.
void freeLS(LS_t *ls);

// Reads the coefficients and the constants of a linear system from input and stores them in ls.
void readLS(LS_t *ls);

// Computes the diagonal of the linear system and stores it in the array d.
...
// Prints the solution and the residue of the linear system.
