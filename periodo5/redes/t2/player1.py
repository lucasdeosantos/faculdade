...
from package import PLAYER1_ID
from addresses import PLAYER1_ADDRESS, PLAYER2_ADDRESS
...
def playerRunner(socket_udp, player, next_machine):
    ...
    while True:
        ...
        if(destination_address != PLAYER1_ADDRESS):
...
def main():
    ...
    socket_udp.bind(PLAYER1_ADDRESS)

    player = blackjack.Player(PLAYER1_ID, PLAYER1_ADDRESS)

    next_machine = PLAYER2_ADDRESS
