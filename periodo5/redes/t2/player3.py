...
from package import PLAYER3_ID
from addresses import PLAYER3_ADDRESS, DEALER_ADDRESS
...
def playerRunner(socket_udp, player, next_machine):
    ...
    while True:
        ...
        if(destination_address != PLAYER3_ADDRESS):
...
def main():
    ...
    socket_udp.bind(PLAYER3_ADDRESS)

    player = blackjack.Player(PLAYER3_ID, PLAYER3_ADDRESS)

    next_machine = DEALER_ADDRESS
